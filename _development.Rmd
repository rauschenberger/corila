...
```{r}
# Add argument seed = 1L to cv.corila to avoid that repeated runs lead to different results (which possibly solves the issue in autotest with alpha_init and group as integer or numeric).
